package com.cloudvision.ui.segment;
...
public class SegmentControl extends View {
    ...
    @SuppressLint("NewApi") public SegmentControl(Context context, AttributeSet attrs, int defStyle){
        ...
        mCurrentIndex = ta.getInt(R.styleable.SegmentControl_selectedIndex,0) ;//榛樿閫変腑绗竴涓�
