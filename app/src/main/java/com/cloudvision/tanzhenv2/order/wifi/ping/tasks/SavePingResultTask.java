package com.cloudvision.tanzhenv2.order.wifi.ping.tasks;
...
import com.cloudvision.tanzhenv2.order.wifi.activity.PingActivity;
...
public class SavePingResultTask extends AsyncTask<IPingResult, Integer, Void> {
    ...
    protected PingActivity activity; // activity that launched the Task

    protected URL url;

    public SavePingResultTask(PingActivity activity, URL url) {
        this.url = url;
